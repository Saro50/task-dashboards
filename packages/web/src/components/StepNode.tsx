...
const statusColors: Record<StepStatus, { bg: string; border: string; bar: string; text: string; dot: string }> = {
...
export default memo(function StepNode({ id, data, selected }: NodeProps) {
